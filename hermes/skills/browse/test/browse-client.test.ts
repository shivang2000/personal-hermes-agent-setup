...
describe('browse-client', () => {
  ...
  describe('resolveBrowseAuth', ()=REDACTED_SET_LOCALLY
    it('uses GSTACK_PORT + GSTACK_SKILL_TOKEN env when present', ()=REDACTED_SET_LOCALLY
    ...
    it('explicit opts.port + opts.token bypass env and state file', ()=REDACTED_SET_LOCALLY
      const auth=REDACTED_SET_LOCALLY
  ...
  describe('command()', () => {
    it('emits POST /command with bearer auth and JSON body', async ()=REDACTED_SET_LOCALLY
