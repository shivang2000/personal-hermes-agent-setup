...
describe('Sensitive value redaction', () => {
  ...
  test('header command redacts Authorization value', async ()=REDACTED_SET_LOCALLY
  ...
  test('header command redacts X-API-Key', async ()=REDACTED_SET_LOCALLY
  ...
  test('forms redacts password field values', async ()=REDACTED_SET_LOCALLY
    await handleWriteCommand('goto', [baseUrl + '/forms.html'], bm);
