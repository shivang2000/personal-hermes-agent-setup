...
// ---------------------------------------------------------------
describe('gstack-brain-sync secret scan', ()=REDACTED_SET_LOCALLY
  const SECRETS: [string, string][]=REDACTED_SET_LOCALLY
    ['aws-access-key', 'AKIAABCDEFGHIJKLMNOP'],
    ['github-token-ghp', 'REDACTED_SECRET'],
    ['github-token-github-pat', 'REDACTED_SECRET'],
    ['openai-key', 'REDACTED_SECRET'],
    ['pem-block', '-----BEGIN PRIVATE KEY-----'],
    ['jwt', 'eyJ0eXAiOiJKV1QiLCJh.eyJzdWIiOiIxMjM0NTY3.SflKxwRJSMeKKF30oGTbU'],
    ['bearer-json', '"authorization":"REDACTED_SECRET"'],
  ];
