...
describeE2E('/setup-gbrain Path 4 — bad token STOPs cleanly', ()=REDACTED_SET_LOCALLY
  test('AUTH classifier fires, no MCP registration, no CLAUDE.md mutation', async ()=REDACTED_SET_LOCALLY
    ...
    const BAD_TOKEN=REDACTED_SET_LOCALLY
    ...
    process.env.GBRAIN_MCP_TOKEN=REDACTED_SET_LOCALLY
    ...
    try {
      ...
      if (orig.mcpToken=REDACTED_SET_LOCALLY
