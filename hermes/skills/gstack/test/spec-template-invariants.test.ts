...
describe('/spec --dedupe gh failure handling', () => {
  test('handles gh-not-installed, unauthed, rate-limited paths', ()=REDACTED_SET_LOCALLY
...
describe('/spec quality gate fallback', () => {
  ...
  test('skips on codex not installed / unauthed', ()=REDACTED_SET_LOCALLY
...
describe('/spec fail-closed redaction (shared engine)', () => {
  test('the full taxonomy (with secret prefixes) lives in the generated /cso doc', ()=REDACTED_SET_LOCALLY
...
describe('/spec quality gate secret-sink invariant', ()=REDACTED_SET_LOCALLY
