...
describe('gstack-learnings-search token-OR query semantics', ()=REDACTED_SET_LOCALLY
  test('multi-token query returns entries matching ANY token', ()=REDACTED_SET_LOCALLY
  ...
  test('single-token query returns only entries matching that token', ()=REDACTED_SET_LOCALLY
