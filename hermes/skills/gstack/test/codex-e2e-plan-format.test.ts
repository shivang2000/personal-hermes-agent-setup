...
describeCodex('Codex Plan Format — CEO Mode Selection', () => {
  ...
  testIfSelected('codex-plan-ceo-format-mode', async () => {
    ...
    console.log(`codex-plan-ceo-format-mode: ${result.tokens}t, ${Math.round(result.durationMs/1000)}s, exit=REDACTED_SET_LOCALLY
...
describeCodex('Codex Plan Format — CEO Approach Menu', () => {
  ...
  testIfSelected('codex-plan-ceo-format-approach', async () => {
    ...
    console.log(`codex-plan-ceo-format-approach: ${result.tokens}t, ${Math.round(result.durationMs/1000)}s, exit=REDACTED_SET_LOCALLY
...
describeCodex('Codex Plan Format — Eng Coverage Issue', () => {
  ...
  testIfSelected('codex-plan-eng-format-coverage', async () => {
    ...
    console.log(`codex-plan-eng-format-coverage: ${result.tokens}t, ${Math.round(result.durationMs/1000)}s, exit=REDACTED_SET_LOCALLY
...
describeCodex('Codex Plan Format — Eng Kind Issue', () => {
  ...
  testIfSelected('codex-plan-eng-format-kind', async () => {
    ...
    console.log(`codex-plan-eng-format-kind: ${result.tokens}t, ${Math.round(result.durationMs/1000)}s, exit=REDACTED_SET_LOCALLY
