...
function systemInit(model = 'claude-opus-4-7', version = '2.1.117'): SDKMessage {
  return {
    type: 'system',
    subtype: 'init',
    apiKeySource: REDACTED_SET_LOCALLY
...
function assistantTurn(
  ...
  return {
    ...
    message: {
      ...
      stop_sequence: null,
      usage: {
        input_tokens: REDACTED_SET_LOCALLY
        output_tokens: REDACTED_SET_LOCALLY
        cache_creation_input_tokens: REDACTED_SET_LOCALLY
        cache_read_input_tokens: REDACTED_SET_LOCALLY
