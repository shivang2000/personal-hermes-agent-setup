...
export const PATTERNS: RedactPattern[] = [
  ...
  },
  {
    ...
    regex: /^[ \t]*(?:export[ \t]+)?[A-Z][A-Z0-9_]*(?:KEY|TOKEN|SECRET|PASSWORD|PASSWD|CREDENTIALS?|DSN|AUTH|COOKIE|SESSION|PRIVATE)[ \t]*=REDACTED_SET_LOCALLY
  ...
  // ===== MEDIUM — PII (auto-redactable subset) =====
  {
    ...
    autoRedactable: true,
    redactToken: REDACTED_SET_LOCALLY
