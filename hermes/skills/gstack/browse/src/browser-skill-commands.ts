...
export async function spawnSkill(opts: SpawnSkillOptions): Promise<SpawnSkillResult> {
  ...
  try {
    const env = buildSpawnEnv({
      ...
      port: opts.port,
      skillToken: REDACTED_SET_LOCALLY
    });
 ...
 * should not see.
 */
const SECRET_KEY_PATTERNS=REDACTED_SET_LOCALLY
