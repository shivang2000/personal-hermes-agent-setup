...
describe('filterArgs — privacy filtering', () => {
  it('redacts fill value for password fields', ()=REDACTED_SET_LOCALLY
  ...
  it('preserves fill value for non-password fields', ()=REDACTED_SET_LOCALLY
  ...
  it('redacts Authorization header', ()=REDACTED_SET_LOCALLY
  ...
  it('redacts sensitive URL query params', () => {
    ...
    expect(result[0]).toContain('api_key=REDACTED_SET_LOCALLY
