...
| delegate_task "capped at N" reports | `references/delegate-taREDACTED_SECRET.md` |
...
- **"delegate_task is capped at N" reports** — see `references/delegate-taREDACTED_SECRET.md`. Three real cap paths in Hermes; if none fired, the model is self-limiting and rationalising it as "the runtime caps."
