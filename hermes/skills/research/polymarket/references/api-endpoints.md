...
```
GET /price?token_id=REDACTED_SET_LOCALLY
```
...
```
GET /midpoint?token_id=REDACTED_SET_LOCALLY
```
...
```
GET /spread?token_id=REDACTED_SET_LOCALLY
```
...
```
GET /book?token_id=REDACTED_SET_LOCALLY
```
