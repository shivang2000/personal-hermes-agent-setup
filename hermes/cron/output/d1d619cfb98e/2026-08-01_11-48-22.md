...
Quote-tweeted successfully.

**Action:** Quote-tweet amplification
**Text:** "Anthropic deleted 80% of Claude Code's system prompt and Opus 5 got smarter. The prompt was compensating for older models, not adding capability. Your 6-month-old agent prompt is probably dragging down your current model. #AIAgents"
**Source:** Boris Cherny (Claude Code creator) YC Startup School interview — Anthropic removed 80% of Claude Code's system prompt when Opus 5 dropped, model improved without it. Highest-engagement tweet by @Nekt_0 (388 likes, 131 reposts).
**URL:** https://x.com/shivangchheda22/status/2083437055242309889
**Quote of:** https://x.com/Nekt_0/status/2083175714338017365
**Image:** None (text-only quote tweet)
**Method:** `x_background.py quote` (headless Playwright, isolated profile, no Arc/desktop interaction)
