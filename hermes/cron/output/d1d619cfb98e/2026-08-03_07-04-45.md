...
**Action:** Original post (with screenshot of Karpathy's source tweet)

**Text:** "Karpathy's Pelican isn't a drawing test, it's a coherence test. Can a model hold state across 5500 lines with no human nudging it back on track? That's what decides whether agent loops survive or break in production, and leaderboards don't measure it. #AIAgents"

**Length:** 261 characters

**Source:** Andrej Karpathy's tweet (https://x.com/karpathy/status/2083749667410727319) — gave Opus 5 the first paragraph of Lord of the Rings, a 1M token budget (~$10), and it produced 5500 lines of Three.js code rendering a procedural 3D world in ~2 hours. 23.5k likes, 2.3k reposts.

**Angle:** Reframes the Pelican experiment from "can the model draw" (surface novelty) to long-horizon state coherence — the same property that determines whether production agent loops stay on track or silently drift. Leaderheads don't capture this; it's a builder-relevant reliability insight, not a benchmark hot take.

**Image:** Screenshot of Karpathy's source tweet attached (313KB, public source only).

**Posted URL:** https://x.com/shivangchheda22/status/2084090508302041397The post was successfully delivered. Nothing further to report — the tweet is live at https://x.com/shivangchheda22/status/2084090508302041397 with the screenshot attached.
