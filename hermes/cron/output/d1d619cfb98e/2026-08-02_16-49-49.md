...
**Text:** "A single invisible HTML comment in a pull request can hijack a reviewer AI coding agent. Microsoft Azure DevOps MCP server had this flaw. Treat fetched content as untrusted input. Strip HTML, CSS, metadata before it reaches model context. #AIAgents"
**Source:** OffensiveLab tweet on Azure DevOps MCP server prompt-injection flaw (Jul 22, 2026) — https://x.com/OffensiveLab/status/2079797351380627748
**URL:** https://x.com/shivangchheda22/status/2083875369992745138
**Image:** Screenshot of the source tweet attached (344 KB)
**Chars:** 248 (under 280)
