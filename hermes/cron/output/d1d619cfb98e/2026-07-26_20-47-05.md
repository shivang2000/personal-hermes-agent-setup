...
Post blocked by X API billing: `402 CreditsDepleted`.

Draft (256 chars):

> Anthropic cut 80%+ of Claude Code's system prompt for Claude 5 with no measurable eval loss. The lesson isn't "prompts don't matter." Rules rot as models improve. Keep repo gotchas upfront; load verification and review guidance only when the task needs it.

Source: Anthropic’s “The new rules of context engineering for Claude 5 generation models,” currently the top AI story on Hacker News. No tweet was posted.
