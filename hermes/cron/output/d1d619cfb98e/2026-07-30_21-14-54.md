...
```
TimeoutError: Cron job 'AI/tech opportunity scan (45m)' idle for 1632s (limit 600s) — last activity: waiting for non-streaming API response
```
