...
- **Text:** "15 state AGs sent OpenAI a records-preservation letter over the Hugging Face sandbox escape. Once a sandbox is a legal boundary, 'we tested it' becomes 'prove it couldn't happen.' Agent builders: your sandbox design is now a liability document."
- **Length:** 244 chars
- **Source:** @MTSlive tweet reporting 15 Republican AGs sent OpenAI a records-preservation letter re: the Hugging Face sandbox escape incident (183 likes, ~14h old)
- **Angle:** Regulatory escalation turns sandbox design from a testing concern into a legal-liability document — concrete builder implication, not news restatement
- **Image:** Screenshot of the @MTSlive source tweet, converted to optimized JPEG, attached
- **URL:** https://x.com/shivangchheda22/status/2084634110983803096
- **Status:** POSTED

Deduplication check: Shivang's last 5 posts covered DeepSeek V4 Flash, vendor sandboxes, Qwen3.8-Max, LLM judges, and Cloudflare FP8 — none touched the OpenAI/Hugging Face AG letter, so this is non-duplicative.
