...
**Text:** "The runtime around the model (planning, tools, memory, verification) matters as much as the weights. AIDE² modified its own harness across 100 iterations in 8 days, beating 2 years of manual R&D tuning. Your eval loop is the actual product."

**Source:** Lilian Weng, "Harness Engineering for Self-Improvement" (lilianweng.github.io, HN frontpage #3, 160+ points). AIDE² data point from Weco AI research.

**URL:** https://x.com/shivangchheda22/status/2084653575926591570

**Image:** Attached screenshot of Lilian Weng's blog post (public primary source).

**Duplicate check:** Shivang's recent posts today covered ADR/Uber, OpenAI Astra math, DeepSeek V4 Flash MI300X, Cloudflare KV cache, and state AGs/sandbox — no overlap with this harness engineering angle.
