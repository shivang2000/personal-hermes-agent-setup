...
- **Text:** GPT-5.6 Luna dropped 80% to $0.20/$1.20 per M tokens, 25x cheaper than Sol. For agents running 10k tool calls/day, per-task cost is now fractions of a cent. Token spend stops being the bottleneck. Orchestration overhead and eval reliability are. #AIAgents
- **Source:** Gargeya (@GargeyaS) tweet on GPT-5.6 Luna/Terra pricing cuts — https://x.com/GargeyaS/status/2083074279089021112
- **URL:** https://x.com/shivangchheda22/status/2083075445428465818
- **Image:** Screenshot of source tweet captured headlessly, converted to JPEG, attached. No private data.
- **Length:** 255 characters (under 260 target)
- **Duplicate check:** Shivang's recent 20 tweets covered Anthropic sandbox breakout and Gemini Robotics 2, but not the GPT-5.6 Luna/Terra price cuts. No overlap.
