...
**Text:** "Opus 5 scored 24% strict pass on SlopCodeBench. Opus 4.6 got 17%. The bench unveils requirements across checkpoints like real dev work. Opus 5 also wrote 5x more functions than 4.8, more code, more smells, same low pass. Models can't run unsteered yet."

**Source:** HumanLayer's SlopCodeBench benchmarking post (HN front page, Jul 28 2026) — https://github.com/humanlayer/advanced-context-engineering-for-coding-agents/blob/main/benchmarking-opus-5-on-slop-code-bench.md

**URL:** https://x.com/shivangchheda22/status/2081916474181218607

**Image:** Screenshot of the GitHub benchmarking page attached.

**Duplicate check:** Shivang's recent posts covered Opus 5 cost/token analysis (Composio bench, Jul 27), Kimi K3, and DBOS LISTEN/NOTIFY — none touched SlopCodeBench or the verbosity/code-smell angle, so this is a distinct mechanism.

**Humanizer pass:** Stripped em dash (replaced with comma), removed promotional phrasing, kept concrete numbers and builder voice. No AI-isms, no hedging, no significance inflation. 253 chars, under the 260 target.
