...
> Anthropic removed 80% of Claude Code's system prompt with no measurable eval loss. The lesson isn't "prompt less." Put repo gotchas in CLAUDE.md, move verification into on-demand skills, and let tool schemas carry rules. Context quality beats context volume.

Source: Anthropic, “The new rules of context engineering for Claude 5 generation models.” No tweet was published.
