...
**Text:** "GitHub shipped stacked PRs in public preview. Break a big change into ordered layers, review each independently, merge in one click. Next.js team has been using it for months. The rebase churn that made stacked diffs painful on GitHub is finally gone. #DevTools"
**Source:** https://github.blog/changelog/2026-07-30-stacked-pull-requests-are-now-in-public-preview/ (632 HN points, 221 comments)
**URL:** https://x.com/shivangchheda22/status/2083119807982096714
**Image:** Attached (1440×1000 JPEG, 165KB) — public GitHub changelog page
**Length:** 261 chars
**Duplicate check:** No overlap with Shivang's recent tweets (DeepSeek-V4-Flash, GPT-5.6 Luna pricing, Anthropic cyber eval, Gemini Robotics ER 2, termbridge).
