...
**Text:** Perplexity open-sourced Numbat: runtime guardrails for coding agents. Live hooks, deterministic detection, pre-action blocking, retrospective artifact scans. Blocking adds latency per tool call but beats an unsupervised agent touching the wrong thing. #AIInfra
**Source:** https://github.com/perplexityai/numbat (tweet by @0x4D31, 22 likes, 4h old)
**URL:** https://x.com/shivangchheda22/status/2084317121497206962
**Image:** Attached — GitHub repo page screenshot (205 KB)
**Length:** 260 charsThe task is already complete. The post was successfully published:
