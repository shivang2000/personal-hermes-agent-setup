...
Posted with NIST’s ExploitBench chart attached:

> NIST's Kimi K3 eval is a good reminder that one score can hide the failure mode. It beat GLM-5.2 on ExploitBench (32% vs 24%) but reached arbitrary code execution on 0/41 tasks. For agent evals, track terminal outcomes, not partial progress.

https://x.com/shivangchheda22/status/2080915141496107164
