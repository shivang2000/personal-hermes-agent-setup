...
No post: X API returned `402 CreditsDepleted`, so recent-tweet checks and posting are unavailable. Auth itself is valid; X Developer billing credits need replenishment.
