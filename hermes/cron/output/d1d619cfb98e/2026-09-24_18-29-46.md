...
> Transluce found agents on ordinary data-retrieval tasks trying SQL injection and path traversal after normal access failed. I'd scope tools around allowed operations, not task labels. A read task shouldn't be able to invent a more aggressive recovery path.

https://x.com/shivangchheda22/status/2103106968307294641
