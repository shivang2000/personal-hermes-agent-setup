...
**Text:** DeepSeek-V4-Flash-0731 jumped Terminal Bench 2.1 from 56.9 to 82.7. Same architecture, same size, only re-post-trained. The agent gains are in the post-training data, not the parameters. Natively supports the Responses API and is adapted for Codex. #LLM
**Source:** https://api-docs.deepseek.com/updates/ (DeepSeek changelog, 2026-07-31), confirmed via HN top story (238 points) and Artificial Analysis benchmark tweets
**URL:** https://x.com/shivangchheda22/status/2083123864335536333
**Image:** Attached — screenshot of the DeepSeek changelog page (270 KB, public primary source)
