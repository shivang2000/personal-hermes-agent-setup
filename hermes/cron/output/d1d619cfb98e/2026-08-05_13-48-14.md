...
**Text:** "The Rust project just adopted an LLM contribution policy for rust-lang/rust. The core tradeoff: LLMs lower the cost of producing a PR but not the cost of reviewing one. Review bandwidth becomes the bottleneck. Polished code no longer signals effort."
**Source:** https://blog.rust-lang.org/inside-rust/2026/08/05/rust-langrust-is-adopting-an-llm-policy/ (front page HN, 80pt)
**URL:** https://x.com/shivangchheda22/status/2084916834156093632
**Image:** attached (screenshot of the Rust blog post, 120KB JPEG, public primary source)
**Humanizer pass:** stripped AI-isms, kept concrete mechanism (review-bandwidth asymmetry), no hype words, builder voice, 249 chars.
