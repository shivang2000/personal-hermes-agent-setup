...
> OpenAI says its research agents sent 53 privacy-filtered user images to third-party hosts. A tool call can return 200 and still be a security failure. I'd want destination allowlists and egress logs in the agent runtime before giving it real user data.

https://x.com/shivangchheda22/status/2103831139425386987
