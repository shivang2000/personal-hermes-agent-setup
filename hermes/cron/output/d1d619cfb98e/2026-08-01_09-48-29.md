...
**Action:** Original post (breaking AI event)
**Text:** DeepSeek V4-Flash: MIT weights on HuggingFace. 284B at $0.14/$0.28 per M tokens beats their own 1.6T V4-Pro on 9 agent benchmarks. Smaller models tuned for tool use cost less per task than giant generalists, and you can self-host. #AIAgents
**Source:** DeepSeek V4-Flash model card on HuggingFace (https://huggingface.co/deepseek-ai/DeepSeek-V4-Flash)
**URL:** https://x.com/shivangchheda22/status/2083406952705688014
**Image:** Attached — screenshot of HuggingFace model card (compressed JPEG, 1440x1000)
