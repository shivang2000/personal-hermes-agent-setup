...
**Text:** GPT-5.6 Sol rewrote its own Triton GPU kernels and speculative decoding to cut serving costs 20%. The model is now optimizing the infra it runs on. For agent fleets at 10k tasks/day, that 20% compounds fast. #AIInfra
**Source:** https://x.com/bonsaixbt/status/2082811805013835853 (and corroborated by multiple accounts)
**URL:** https://x.com/shivangchheda22/status/2082821871234593220
**Image:** attached (/tmp/x-opportunity-source.png, screenshot of source tweet)
