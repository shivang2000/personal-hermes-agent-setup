...
**Posted (quote tweet):** https://x.com/shivangchheda22/status/2084841086330216460

**Text:** "Post-training is quietly beating model scaling. DeepSeek retrained the same architecture: 67 to 83 on agent benchmarks, no size increase. Your harness, training data, and evals are the levers now, not a bigger model."

**Action:** Quote tweet of @RimonR23's DeepSeek V4 Flash post (84 likes, 60 replies) — adding the post-training-vs-scaling thesis as a new angle, not restating the news.

**Source:** DeepSeek V4 Flash release (Aug 4, 2026) — same architecture, retrained only, agent benchmark 67→83.

**Image:** Screenshot of the source tweet attached.
