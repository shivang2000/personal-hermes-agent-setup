...
> DBOS's test hit 60K writes/sec with Postgres LISTEN/NOTIFY. Impressive, but it still isn't durable: a disconnected worker misses notifications. Keep events in an outbox table and use NOTIFY only as the wake-up signal.

https://x.com/shivangchheda22/status/2080964360852361280

Tweet ID: `2080964360852361280`
