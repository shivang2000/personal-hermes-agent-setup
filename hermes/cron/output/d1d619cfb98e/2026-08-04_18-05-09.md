...
**Text:** "Vendor sandboxes lie. Tripjack UAT supports post-booking on 3 domestic carriers only. International routes return modification-not-allowed. Sandbox limit, not your bug. We built a per-carrier QA matrix and map vendor errors to structured UI states, never raw vendor text."
**Source:** Post-booking flight QA runbook from AIConcierge321 (`docs/qa/postbooking-flight-runbook.md`) — vendor sandbox limitations, per-carrier QA matrix, structured error-to-UI-state mapping
**URL:** https://x.com/shivangchheda22/status/2084619094935142581
**Image:** None (internal doc, not a public primary source)
**Chars:** 271/280The job is already complete. The tweet was posted successfully:
...
- **Chars:** 271/280
- **Image:** None
- **Source:** Post-booking flight QA runbook from AIConcierge321
