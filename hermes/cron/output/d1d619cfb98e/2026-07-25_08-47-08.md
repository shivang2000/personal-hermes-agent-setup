...
**Tweet posted:** https://x.com/shivangchheda22/status/2080854822237139142

**Text:** "Same price as Opus 4.8 ($5/M in, $25/M out) but #1 on Artificial Analysis. The effort setting lets you dial intelligence per task: full power for hard problems, throttle down for chores. The cost/intelligence ratio for production agents just moved. #AIAgents"

**Rationale:** Claude Opus 5 launched today and is the top story on HN (1356 points) and #1 on Artificial Analysis. Shivang hadn't covered it yet. The angle focuses on the cost/intelligence ratio shift — same price as Opus 4.8 but top-tier performance, plus the effort setting as a concrete mechanism for production agent cost control. Quote-tweet attempted but X API returned 403 (quote tweets restricted on this tier), so posted as standalone instead.
