...
**Text:** "Qwen3.8-Max: 2.4T params, 1M context, open weights next week. 27B goes open too. Does agentic coding survive the size cut or need 2.4T scale? Open weights mean you can actually test it. #OpenSource"
**Source:** Multiple X posts confirming Qwen3.8-Max announcement (2.4T params, 1M context, open weights next week, 27B open release)
**URL:** https://x.com/shivangchheda22/status/2084584971155693692
**Image:** None (no clean public benchmark chart available to capture headlessly; text-only is better than filler)
