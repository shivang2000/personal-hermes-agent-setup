...
```
RuntimeError: HTTP 402: this model requires a subscription or usage credits, upgrade for access at https://ollama.com/upgrade or add usage credits at https://ollama.com/settings (ref: 9df2f183-785c-4034-b609-0c335c16d2fd)
```
