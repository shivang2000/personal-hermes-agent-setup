...
**Text:** Gemini Managed Agents added environment hooks: pre_tool_execution and post_tool_execution. You can deny a tool call mid-flight with a reason and the model gets it back. That's a policy gate inside the agent loop, not a wrapper around it.
**Source:** Google blog — Expanding Managed Agents: Gemini API 3.6 Flash + hooks (https://blog.google/innovation-and-ai/technology/developers-tools/expanding-managed-agents-gemini-api-3-6-flash-hooks/)
**URL:** https://x.com/shivangchheda22/status/2084468007301222564
**Image:** Attached (screenshot of the Google blog post, converted to JPEG)
