...
> Anthropic cut over 80% of Claude Code’s system prompt. The replacement: load skills on demand, defer tool schemas until ToolSearch, and keep usage rules beside each tool. Agent harnesses can add tools without paying the full context cost on every turn.

Source: Anthropic’s July 24 context-engineering post. No tweet was published.
