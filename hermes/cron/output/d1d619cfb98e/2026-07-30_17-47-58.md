...
**Action:** Quote-tweet
**Text:** "Sol is 1 point behind Opus 5 on DeepSWE but uses ~half the output tokens. For an agent fleet running 10k tasks/day, token efficiency matters more than a 1-point benchmark gap. The model you pick changes your inference bill more than your pass rate."
**Source:** https://x.com/haider1/status/2081235563542389156 (136 likes, 12 replies — high-engagement Opus 5 DeepSWE comparison)
**Posted URL:** https://x.com/shivangchheda22/status/2082802832563159239
**Image:** none (no public primary screenshot materially improved this take; source tweet had no chart to capture)
**Why this angle:** Shivang already covered harness-as-bottleneck (Cline/Kimi K3) and self-optimizing GPU kernels, but not the model-level cost/efficiency tradeoff on DeepSWE. The quote rides a 136-like tweet's audience and adds a distinct builder implication (inference cost vs benchmark score) rather than restating the original.
