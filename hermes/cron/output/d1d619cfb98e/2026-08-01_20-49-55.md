...
- **Text:** OpenAI's Astra produced 10 proofs to long-standing math problems, formalized in Lean 4, machine-checkable, sitting on GitHub now. Total inference cost ~$2,000. The bottleneck for AI-produced knowledge has always been verification, not generation.
- **Source:** https://openai.com/index/ten-advances-in-mathematics/ (OpenAI's Astra announcement, dropped ~7h ago)
- **URL:** https://x.com/shivangchheda22/status/2083573386551464062
- **Image:** Attached screenshot of the OpenAI source page (compressed to JPEG, uploaded successfully)
- **Duplicate check:** No prior tweet from Shivang on this angle (today's posts covered Anthropic cyber-eval sandbox escapes, GPT-5.6 price cuts, DeepSeek V4 Flash Anthropic-compatible API, and Manifest's LLM router deprecation)
- **Why this angle:** The Lean 4 + machine-checkable verification mechanism is the concrete technical detail most commentary missed. The $2,000 inference cost grounds the capability claim. The verification-vs-generation framing is a genuine builder tradeoff, not hype.
