...
```
TimeoutError: Cron job 'AI/tech opportunity scan (45m)' idle for 1069s (limit 600s) — last activity: terminal command running (10s elapsed)
```
