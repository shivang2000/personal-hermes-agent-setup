...
- **Text:** "LLM judges don't use the full scale. swe-chat paper (Baumann et al.): judge scored 5,411 agent sessions 0-100, but 85.3% landed on 2 or 8. Your continuous eval is secretly binary. A 70-point pass threshold measures judge rounding, not agent quality."
- **Source:** https://x.com/leopalamim/status/2084602952740741302 (swe-chat paper, Baumann et al., 2026 — LLM judge score clustering)
- **URL:** https://x.com/shivangchheda22/status/2084604297384513857
- **Image:** Attached screenshot of the source tweet (184KB, public)
- **Why this angle:** Concrete eval-reliability mechanism (judge scores collapsing to 2 values on a 0-100 scale) directly relevant to builders running LLM-judge evals. No duplicate in Shivang's recent 20 posts. Timely (source posted minutes ago). 249 chars.
