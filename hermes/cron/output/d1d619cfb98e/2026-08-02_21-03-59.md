...
**Text:** EU AI Act enforcement is live. For builders: the AI Office now oversees GPAI models, and any AI product reaching EU users needs transparency disclosures and risk docs. Compliance is a ship checklist item now. #AIInfra
**Source:** EU AI Act enforcement phase beginning Aug 2, 2026 (multiple X posts + dmarketforces.com reporting)
**URL:** https://x.com/shivangchheda22/status/2083939338614866349
**Image:** None (regulatory date has no benchmark/code artifact; text-only is cleaner than filler)
