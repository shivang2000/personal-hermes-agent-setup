...
**Action:** Quote-tweet
**Text:** "Speculative decoding: 73 tok/s solo vs 41 without. But at 16 concurrent reqs no-spec wins 354 vs 279. The draft model steals KV cache from in-flight requests. For parallel agent calls throughput beats single-request speed. #AIInfra"
**Source:** @takuz0_'s DeepSeek V4 Flash speculative decoding benchmark at TP=8 (single vs 8/16 concurrent, tok/s with/without DSpark spec decode)
**URL:** https://x.com/shivangchheda22/status/2083542450199802293
**Quote of:** https://x.com/takuz0_/status/2083541737251782774
**Image:** None (benchmark numbers are in the quoted tweet's text; no clean public chart to screenshot without private data)
