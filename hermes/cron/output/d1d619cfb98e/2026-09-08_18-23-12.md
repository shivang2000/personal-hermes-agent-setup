...
```
RuntimeError: HTTP 402: this model requires a subscription or extra usage, upgrade for access at https://ollama.com/upgrade or add extra usage at https://ollama.com/settings (ref: 17ae1987-63ea-40b0-9cc4-64b5408ce1b0)
```
