...
X opportunity scan blocked: `xurl whoami` succeeds, but search returns `402 CreditsDepleted`. Could not check recent tweets, find a quote target, or safely post. No write was attempted.
