...
Posted a quote-tweet on the Boris Cherny / Claude Code system-prompt deletion insight.

**Action:** Quote-tweet
**Text:** "Anthropic deleted 80% of Claude Code's system prompt for Opus 5 and it got better. Your prompt scaffolding depreciates as models improve. Less time writing guardrail instructions, more on evals that catch when the model drifts."
**Source:** https://x.com/alex_prompter/status/2083640104158126186 (299 likes, 32 reposts)
**Posted URL:** https://x.com/shivangchheda22/status/2084282408686514522
**Image:** none (text-only; no public screenshot materially improved this take)

Humanizer pass applied: stripped AI-isms, kept Shivang's direct builder voice, concrete mechanism (system prompt deletion), tradeoff (scaffolding depreciation vs. eval investment), under 280 chars.
