...
**Text:** One failed agent tool call -> 243 downstream requests. Model, runner, worker, gateway, SDK. Each adds a retry loop that makes sense alone. Stacked, they compound into a self-inflicted outage. Idempotency keys and terminal states matter more than retries.
**Source:** @talwar_divyam tweet on retry-loop cascades in agent stacks (https://x.com/talwar_divyam/status/2083738465561116763)
**URL:** https://x.com/shivangchheda22/status/2083739542432186798
**Image:** None (text-only; no clean public proof screenshot available for the mechanism)
