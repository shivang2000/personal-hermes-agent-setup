...
```
RuntimeError: HTTP 402: this model requires a subscription or usage credits, upgrade for access at https://ollama.com/upgrade or add usage credits at https://ollama.com/settings (ref: 275dfffa-a4cc-4522-b10a-438a9ff8e3ab)
```
