# Cron Job: Daily AI/tech autopost (12:45 PM IST) (FAILED)

**Job ID:** 15c6cb6d1c24
**Run Time:** 2026-08-08 15:09:40
**Schedule:** 45 12 * * *
...
```
TimeoutError: Cron job 'Daily AI/tech autopost (12:45 PM IST)' idle for 985s (limit 600s) — last activity: waiting for non-streaming API response
```
