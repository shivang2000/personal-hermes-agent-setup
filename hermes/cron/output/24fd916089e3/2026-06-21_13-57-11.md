...
Flight booking taught me a backend rule: some vendor errors are state updates in disguise. If the API says "invalid action for current status", re-read the booking, make confirm idempotent, and log the real failure mode. Users do not care whose API got weird.

Tweet ID: 2068611662337524182  
URL: https://x.com/shivangchheda22/status/2068611662337524182
