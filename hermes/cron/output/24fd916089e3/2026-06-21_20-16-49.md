...
Agentjacking lesson from @TheHackersNews: the prompt injection isn't in chat. It can be a Sentry error event your coding agent reads via MCP. Once agents get bash/write access, input provenance and permission boundaries matter more than prompt hygiene. #AIAgents #AIInfra

Source/angle: The Hacker News covered Agentjacking as a Sentry/MCP/coding-agent attack path; the post frames the concrete security tradeoff around external input provenance and agent permissions.

Tweet ID: 2068707196003885469  
URL: https://x.com/shivangchheda22/status/2068707196003885469
