...
Posted: https://x.com/shivangchheda22/status/2068801908694032875

Text:
Takeaway from @OpenAI's simulated deployment evals: final-answer checks miss a lot. For agents, the eval surface is the trajectory: stateful tool calls, retries, context, and whether the simulator behaves like production. #AIAgents #AIInfra

Rationale: Source-backed angle from OpenAI’s recent simulated deployment evals post, tied to agent trajectories, stateful tool calls, retries, context, and production-like simulators.
