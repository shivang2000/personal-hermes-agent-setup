...
React state is not a lock. In payment/booking flows, a rapid double-tap can hit the async confirm path before the disabled button re-renders. I now use a synchronous useRef latch around the confirm call. Tiny frontend guard, much less backend chaos.

ID: 2068623634885943623  
URL: https://x.com/shivangchheda22/status/2068623634885943623
