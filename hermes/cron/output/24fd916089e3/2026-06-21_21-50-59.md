...
Posted: https://x.com/shivangchheda22/status/2068730895230751143

Text:
I liked @usedotai's Hermes agent demo because it shows where agent APIs are going: past "chat completion + tools." The hard bit is streamed tool-call execution with privacy boundaries, retries, and traceable state. #AIAgents

Rationale: source-backed angle from @usedotai's recent Hermes/@base MCP demo with concrete mechanisms: streamed tool-call execution, privacy boundaries, retries, and traceable state.
