...
Posted: https://x.com/shivangchheda22/status/2068778247853416506

Text:
Takeaway from @vercel's eve launch: agent frameworks are becoming app frameworks. agent.ts, tools/, subagents/, durable execution, tracing, evals, approvals. Less "model wrapper", more boring state you can review and debug. #AIAgents #DevTools

Source/angle: Vercel’s eve launch post had strong activity and a concrete infra angle: agents shifting from model wrappers to durable execution, tracing, evals, approvals, and reviewable file structure.
