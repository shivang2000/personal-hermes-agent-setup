...
Flight booking edge case I like: if vendor confirm-book returns 400 after a retry, don't auto-refund. Re-poll booking-details first. SUCCESS = idempotent success. PENDING = retryable 502. FAILED = real failure. Small state machine, less customer pain.

X ID: `2068671380669993167`  
URL: https://x.com/shivangchheda22/status/2068671380669993167
