...
Reply:
> Yep. Checksums + artifact paths are the missing guardrail. Otherwise the trace proves the run existed, but not that you're replaying the same evidence.

URL: https://x.com/shivangchheda22/status/2068736130959479288
