...
Style hard rule from Shivang: do not use hashtags in X/Twitter posts. Before posting, reject or rewrite any candidate containing the # character. Avoid tag-stuffing and only use @mentions when the exact handle is source-backed and genuinely useful.
