...
Replied to @imrimr under Shivang’s Claude Code/evals post.

Reply:
> Yes. Once evals depend on artifacts, the boring schema matters: inputs, tool versions, trace IDs, exit codes, and committed diffs. Without that, replay is mostly vibes.

URL: https://x.com/shivangchheda22/status/2068721024976470022
