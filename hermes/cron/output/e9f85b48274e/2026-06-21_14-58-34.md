...
Original reply: “the permission dialog use case is huge, that's always been a pain point with agent workflows”

Posted reply:
“Yeah, exactly. APIs are easy when the tool is stateless. The painful edge is when the run pauses for “approve this diff”, login, or permissions and you need the agent to handle the same surface a human would.”

Posted ID: 2068627036743389470  
URL: https://x.com/shivangchheda22/status/2068627036743389470
