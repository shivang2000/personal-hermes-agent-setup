...
Reply:
> Exactly. The checksum only answers "same bytes?" Policy + env answers "same contract?" You need both before replay means anything.

In response to:
https://x.com/imrimr/status/2068750870267732372

Posted:
https://x.com/shivangchheda22/status/2068751405138260465
