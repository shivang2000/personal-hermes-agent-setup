...
Replied to @i_mika_el:

> Yep. The annoying part is preserving the exact terminal state after the prompt: cwd, env, pending diff, and what the agent already tried.

URL: https://x.com/shivangchheda22/status/2068681696783036457
