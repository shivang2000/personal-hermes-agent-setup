...
- Original reply summary: agreed that terminal-as-MCP makes sense because auth prompts and permission dialogs are where pure API wrappers leak.
- Reply text: “Exactly — the messy part isn’t the command call, it’s keeping the session controllable when a CLI asks for auth, permissions, or a decision mid-run.”
- Posted reply: https://x.com/shivangchheda22/status/2068566536361845079
