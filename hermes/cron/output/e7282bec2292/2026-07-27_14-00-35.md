...
No replies posted. X authentication is healthy, but both search requests failed with `402 Payment Required: credits depleted`. The scanner cannot find candidates or check duplicate replies until X API credits are replenished.
