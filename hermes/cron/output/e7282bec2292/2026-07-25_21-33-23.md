# Cron Job: Reply-engagement scanner for AI accounts (30m) (FAILED)

**Job ID:** e7282bec2292
**Run Time:** 2026-07-25 21:33:22
**Schedule:** */30 7-22 * * *
...
```
TimeoutError: Cron job 'Reply-engagement scanner for AI accounts (30m)' idle for 658s (limit 600s) — last activity: initializing
```
