...
https://x.com/NVIDIAAI/status/2081666750807171180

I'd like to see the harness ablation: same model and tasks, with and without NOOA. Agent pass rates are hard to compare without tool-call budgets, retry counts, token cost, sandbox policy, and failure traces. The orchestration layer can hide a lot of the result.
