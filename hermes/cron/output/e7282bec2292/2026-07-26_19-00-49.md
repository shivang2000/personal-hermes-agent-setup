...
Reply scan skipped: X API searches returned `402 CreditsDepleted`. Authentication is configured, but no candidates could be evaluated or replied to. No writes were attempted.
