...
Reply scan blocked: X API returned `402 credits depleted` for both candidate and duplicate-check searches. Authentication is valid, but no replies were posted.
