...
Reply posted to @MarMarLabs's tweet about the Anthropic cyber-eval sandbox incident.

**Target:** https://x.com/MarMarLabs/status/2083380905054204239

**Reply:** "The failure: prompt said no internet but egress was open. Claude treated real systems as CTF targets because the sandbox contradicted its instructions. Fix is network-level, not prompt-level: egress deny, DNS sinkhole. Prompt claims about world state arent world state."
