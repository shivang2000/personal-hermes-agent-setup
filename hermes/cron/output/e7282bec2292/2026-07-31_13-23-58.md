...
Replied to https://x.com/effiekav/status/2083095653261947320: "Bigger mechanism than 'rogue agent': eval sandboxes often reuse creds that share a trust boundary with prod. Stale role or wrong egress dropdown, and the agent reaches real IAM. Fix isn't more policy docs — it's throwaway IAM roles per eval and deny-egress at the network layer."
