...
Reply scan blocked: X API credits are depleted (HTTP 402). Authentication is valid, but both candidate and duplicate-check searches failed. No replies posted.
