...
**Target:** https://x.com/0xyunss/status/2082796757038350410
**Reply:** "The burn is compaction. Newer agents compress context every N turns, but the compressed summary itself becomes fresh input on the next call. Cache hit rate drops, fresh tokens spike. Watch cache_read vs cache_write ratio per turn, not total tokens."
