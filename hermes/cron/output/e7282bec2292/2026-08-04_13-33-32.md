...
**Target:** https://x.com/seeconvm/status/2084537756735180979
**Reply:** The harness is where production agents live or die. We hit vendor timeouts, partial API failures, stuck payments in booking flows. Without terminal states and idempotent retries you get ghost bookings: agent thinks it succeeded, vendor never got the request.
