...
**Target:** https://x.com/talwar_divyam/status/2083400263789060114
**Reply:** "The 'what done means' problem is a state-verification problem. 9.9M tokens across 231 episodes guarantees context loss. Checkpoint to external state every N turns so the agent checks completion against a known state, not its own compressed context."
