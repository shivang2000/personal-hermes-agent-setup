...
Reply scan blocked: X API returned `402 CreditsDepleted` for both candidate and duplicate-check searches. Authentication is working, but no replies were posted. X API credits need to be topped up before the scanner can resume.
