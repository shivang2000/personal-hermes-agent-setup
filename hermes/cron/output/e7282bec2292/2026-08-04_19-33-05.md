...
**Reply:** The $200 to $20 is real but the savings hide the ops tax. Self-hosted agent loops need their own retry logic, context window management, model routing, and observability. API cost shows on a dashboard. Infra cost shows up as 3am pages.
