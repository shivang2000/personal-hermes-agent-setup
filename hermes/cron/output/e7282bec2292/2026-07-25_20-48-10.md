...
Reply scan blocked: X API returned `402 CreditsDepleted` for both candidate and duplicate-check searches. Authentication is healthy for `@shivangchheda22`; no replies were posted. X API credits must be topped up before the scanner can resume.
