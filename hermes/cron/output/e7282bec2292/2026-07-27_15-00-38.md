...
Reply scanner blocked: X search returned `402 Payment Required — credits depleted`. Authentication is healthy for `@shivangchheda22`, but no candidates could be evaluated or replied to. Add X API credits before the next scan.
