...
**Reply:** The missing layer is a retry budget, not better retry logic. Each layer is locally rational — 3 retries at 5 layers = 243 calls. A shared circuit breaker at the gateway plus idempotency keys on writes means retried calls do not duplicate side effects or cascade.
