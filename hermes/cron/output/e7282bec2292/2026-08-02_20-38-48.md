...
**Target:** https://x.com/arpit_bhayani/status/2083514139612508513
**Reply:** "Sloppy code and unreliability compound each other. Agent-generated code merges without a verification loop, then the next run inherits that drift and produces worse output on top. Token cost is the symptom. Missing eval gates and idempotent tool calls are the leak."
