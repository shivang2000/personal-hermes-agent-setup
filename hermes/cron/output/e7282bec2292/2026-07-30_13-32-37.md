...
**Target:** https://x.com/VaibhavSisinty/status/2082625370873086377
**Reply:** "The failure isn't the model running a bad migration. It's giving an agent a tool that can execute destructive DDL on prod without a dry-run gate. Read-only creds by default, migration allowlist that blocks reset/drop, human-in-the-loop on every schema change."
