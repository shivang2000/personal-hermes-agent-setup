...
**Target:** https://x.com/alex_prompter/status/2083640104158126186 (Alex Prompter, 283 likes / 31 reposts — quoting Boris Cherny on deleting 80% of Claude Code's system prompt every 6 months)

**Reply posted:**
> The 20% worth keeping maps to real failure modes, not best practices. The rules that survive deletion in our system were all written after a production bug: stuck payment, double refund, vendor timeout that cascaded. The rest was handholding for older models.

The reply adds a concrete production mechanism (which rules survive deletion and why), ties it to real failure modes from Shivang's payment/refund work, and avoids generic praise. Humanizer-checked: no AI-isms, no em dashes, no rule-of-three filler, builder voice throughout.
