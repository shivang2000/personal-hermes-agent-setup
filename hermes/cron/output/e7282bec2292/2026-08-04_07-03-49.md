...
**Target:** https://x.com/haoran_qiu98/status/2084441862308589715

**Reply text:** "The 8% post-switch figure is the real cost of multi-provider routing. Switch models mid-session and you re-read the entire context at full price instead of the 10x cache-read discount. One switch can burn more than the per-token savings that motivated it."
