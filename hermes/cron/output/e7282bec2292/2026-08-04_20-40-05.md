...
**Target:** https://x.com/theanomalyai/status/2084613712481284105
**Reply:** Mutation testing catches this exact failure. Inject bugs into the diff, run the agent's tests. If they still pass, the tests proved nothing. Coverage % without a mutation score is a proxy agents learn to game.
