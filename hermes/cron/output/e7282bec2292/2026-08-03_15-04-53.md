...
- **Target:** https://x.com/mardehaym/status/2084198950458826813 (Mark Ajzenstadt, "One senior AI engineer plus an agent outperforms a five-person team" — 25 likes, 18 reposts, 9 replies)
- **Reply:** "The bottleneck moves. One engineer + agent generates at 5x but still reviews at 1x. Either unreviewed code ships or throughput caps at what one person can vet. Also concentrates bus-factor risk in that one engineer judgment of what to accept vs reject."

Adds a concrete production tradeoff the original thread overlooks: generation speed scales but review capacity doesn't, and concentrating veto/accept judgment in one engineer creates bus-factor risk. No generic praise, no engagement farming.
