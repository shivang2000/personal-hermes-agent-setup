...
Reply posted to @AnthropicAI's AISI cyber-evaluation report tweet.

**Target:** https://x.com/AnthropicAI/status/2084748111239344556
**Reply:** "Intentionally extreme setup is correct. The production failure mode I've seen more than jailbreaks: someone disables the safety classifier because it blocked a legit workflow and the launch was behind. Safeguards that block real work get quietly turned off."

Status: REPLIED. No image attached (no public-source screenshot added evidence beyond the text). The Anthropic account has 205+ replies and 1.3k likes, placing Shivang's handle in front of a large AI audience. The reply adds a concrete production failure mode (guards getting quietly disabled to unblock launches) rather than restating the original post.
