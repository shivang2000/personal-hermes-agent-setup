...
The missing item is state-transition testing. In production, agent failures often look like duplicate tool calls, stale booking state, or retries after a timeout. Trace IDs, idempotency keys, and replayable evals catch these better than another prompt pass.
