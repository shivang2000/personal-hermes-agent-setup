...
**Target:** https://x.com/mardehaym/status/2084216327649050932 (Mark Ajzenstadt — prompt injection in coding agents via README files; 24 likes, 20 reposts, 6 replies)

**Reply posted:**
"README injection is real but the fix isn't prompt-level. Sandbox the agent's FS writes, scope tool calls to an allowlist, treat every file it reads as untrusted input. The boundary that matters is between read context and write actions. Model self-check isn't a guardrail."

Status: REPLIED — https://x.com/mardehaym/status/2084216327649050932Reply posted successfully.
...
Status: REPLIED — https://x.com/mardehaym/status/2084216327649050932Status: REPLIED — https://x.com/mardehaym/status/2084216327649050932https://x.com/mardehaym/status/2084216327649050932
