...
Replied to https://x.com/itsjackdev/status/2083515984519024644

> Verification is the hard one because it needs a ground-truth oracle. Most teams plug in LLM-as-judge, which correlates with the model under test and misses the silent-wrong-output cases that break production. Cheapest real signal: just run the code.
