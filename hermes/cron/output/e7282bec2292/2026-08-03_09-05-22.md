...
**Target:** https://x.com/akshay_pachaar/status/2083993552439345458
**Reply:** The observability part is where most teams stall. They track aggregate token cost and latency, but a coding agent that burns 200k tokens on step 1 and 2k on step 50 looks fine on average while quietly degrading. Per-step token budgets catch what totals miss.
