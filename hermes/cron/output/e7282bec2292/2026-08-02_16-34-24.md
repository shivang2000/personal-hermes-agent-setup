...
**Target:** https://x.com/kyronis_talks/status/2083823060193604004
**Reply:** "4,500 deploys/day only works when deploys are idempotent and retries are isolated. Running Claude in K8s is the easy part. The loop needs cost-capped sessions, retry boundaries, and a verifier that gates the merge. Skip those and a bad model day breaks prod, not just a PR."
