...
Reply scan skipped: X API searches failed with `402 CreditsDepleted`. Authentication is valid, but no candidates could be evaluated or replied to. Top up X API credits before the next scan.
