...
Reply scan blocked: X API returned `402 CreditsDepleted` for both candidate and duplicate-check searches. Authentication is healthy (`@shivangchheda22`), but no replies were posted.
