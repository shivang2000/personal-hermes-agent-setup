...
Reply scan blocked: X API returned `402 CreditsDepleted` for both candidate and duplicate searches. Authentication is valid, but no replies were posted.
