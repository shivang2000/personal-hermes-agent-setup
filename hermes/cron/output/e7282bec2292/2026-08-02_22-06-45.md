...
**Target:** https://x.com/emollick/status/2083773822579216424 (Ethan Mollick, @emollick — 61 likes, large account)

**Reply:** Reasoning models already spend inference compute on internal CoT, so 'think step by step' is redundant there and can over-constrain the natural reasoning path. Still helps on non-reasoning models for multi-step tasks. The model allocates thinking now, not the prompt.

Status: REPLIEDReply posted successfully.

**Target:** https://x.com/emollick/status/2083773822579216424 (Ethan Mollick, @emollick — 61 likes, large following)

**Reply posted:** Reasoning models already spend inference compute on internal CoT, so 'think step by step' is redundant there and can over-constrain the natural reasoning path. Still helps on non-reasoning models for multi-step tasks. The model allocates thinking now, not the prompt.
