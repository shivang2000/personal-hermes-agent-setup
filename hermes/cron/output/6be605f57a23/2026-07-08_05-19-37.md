...
```
TimeoutError: Cron job 'Hourly sync status reporter' idle for 1024s (limit 600s) — last activity: waiting for stream response (5170s, no chunks yet)
```
