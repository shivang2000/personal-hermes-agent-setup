...
```
TimeoutError: Cron job 'Hourly sync status reporter' idle for 609s (limit 600s) — last activity: waiting for stream response (1297s, no chunks yet)
```
