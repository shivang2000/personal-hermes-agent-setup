...
```
RuntimeError: HTTP 429: {"error":"you (shivangchheda) have reached your weekly usage limit, upgrade for higher limits: https://ollama.com/upgrade (ref: 2e269533-0821-4705-9a4b-1a3e323fbf8f)"}
```
