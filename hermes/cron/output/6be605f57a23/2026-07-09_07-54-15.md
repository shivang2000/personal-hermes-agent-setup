...
```
TimeoutError: Cron job 'Hourly sync status reporter' idle for 973s (limit 600s) — last activity: waiting for stream response (7520s, no chunks yet)
```
