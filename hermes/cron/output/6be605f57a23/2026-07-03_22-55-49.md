...
```
TimeoutError: Cron job 'Hourly sync status reporter' idle for 613s (limit 600s) — last activity: waiting for stream response (2146s, no chunks yet)
```
