...
```
TimeoutError: Cron job 'Hourly sync status reporter' idle for 1062s (limit 600s) — last activity: waiting for stream response (656s, no chunks yet)
```
