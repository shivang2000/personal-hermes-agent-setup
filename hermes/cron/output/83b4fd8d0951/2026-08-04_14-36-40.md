...
- **Text:** OpenAI cut GPT-5.6 Luna 80% to $0.20/$1.20 per M tokens. Terra down 20%. Sol didn't move at all. That asymmetry tells you where the margins are: Sol holds cost-plus, Luna is priced for market share. Route agents accordingly. #AIInfra
- **URL:** https://x.com/shivangchheda22/status/2084566622396956738
- **Source:** OpenAI developer pricing page (https://developers.openai.com/api/docs/pricing) — confirmed Luna at $0.20/$1.20, Terra at $2.00/$12.00, Sol unchanged at $5.00/$30.00. Cross-referenced with TechCrunch launch article (Jul 9, 2026) confirming original Luna price of $1/$6.
- **Image attached:** Yes — screenshot of the OpenAI API pricing table showing the current per-million-token rates for all GPT-5.6 variants.
