...
**Breaking-news post — Inkling-Small (Thinking Machines)**

**Tweet text:**
> Inkling-Small from Thinking Machines: 276B MoE, 12B active, Apache 2.0. Matches the 975B Inkling on AA Intelligence Index within 1 point at a quarter the params. But Omniscience is -9: when it doesn't know, it guesses. #OpenSource

**X URL:** https://x.com/shivangchheda22/status/2083932263281197384
**Image attached:** Yes — cropped screenshot of the Inkling / Inkling-Small model cards from thinkingmachines.ai/inkling
**Primary source:** https://www.thinkingmachines.ai/inkling/ (confirms 276B total / 12B active, open weights, multimodal, NEW label) + Artificial Analysis Intelligence Index v4.1 leaderboard + AA Omniscience data from X search results
**Status:** POSTEDThe post is already complete. The tweet was successfully posted with `status: POSTED` and a verified X URL. Nothing further to do — the full report was delivered above.
