...
**Tweet text:** DeepSeek V4 Flash 0731 is #3 on Artificial Analysis intelligence index, behind only Opus 5 and GPT-5.6 Sol. 284B MoE, 13B active, 1M context, MIT license, open weights. $0.14/$0.28 per 1M. Cache hit $0.003 — cheapest of any frontier model. #OpenSource #LLM

**X URL:** https://x.com/shivangchheda22/status/2084098153666773209

**Image attached:** Yes — screenshot of Artificial Analysis model page showing DeepSeek V4 Flash 0731 benchmark rankings, intelligence index (#3/101), and pricing data.

**Source:** Artificial Analysis (https://artificialanalysis.ai/models/deepseek-v4-flash) — primary benchmark source. Cross-referenced with DeepSeek API docs (https://api-docs.deepseek.com/) confirming model specs, pricing, and public beta status.

**Why this qualifies as breaking:** Significant open-source model release — 284B MoE with MIT license hitting #3 on a major independent intelligence index, with frontier-competitive pricing. First major DeepSeek V4 Flash API public beta with agent capabilities (tool calls, search, Responses API, Anthropic API compat). No duplicate from Shivang's recent posts.
