...
**Text:** Qwen3.8-Max: 2.4T params, 1M context, open weights next week. The real story isn't benchmarks — it ran 16 days of autonomous coding with zero human review. Issue state machine, dispatcher, watchdog, self-test + CI loop. 265 commits, 127 PRs. #AIAgents

**URL:** https://x.com/shivangchheda22/status/2084256470422741433

**Source:** https://qwen.ai/blog?id=qwen3.8 (Qwen team's official release blog, 2026-08-03). Confirmed via HN front page (699 points, #3) and X search showing multiple independent posts within minutes.

**Image attached:** Yes — screenshot of the Qwen3.8-Max blog page (1440×1000, 634KB).

**Why this is breaking:** Qwen3.8-Max is a major new model release — 2.4T parameter MoE, first open-source Max-class weights from Qwen, 1M token context. The autonomous coding angle (16 days, zero human review, state machine + CI loop) is the concrete mechanism that makes this relevant to the agent/infra audience rather than just another benchmark headline.
