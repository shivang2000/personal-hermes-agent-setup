...
**Breaking-news post fired.** Status: POSTED, verified X URL.

**Tweet:** OpenAI cut GPT-5.6 Luna 80% to $0.20/$1.20 per M tokens. Sol rewrote its own GPU kernels and speculative decoding pipeline in Codex, and those inference savings funded the price cut. Sol Fast mode: 2x price for 2.5x speed. #LLM

**URL:** https://x.com/shivangchheda22/status/2083110478923116850

**Source:** OpenAI developer pricing page (developers.openai.com/api/docs/pricing) — confirmed Luna at $0.20/$1.20 Standard, Sol Fast mode at 2x pricing, and "Priority processing was renamed Fast mode on July 30, 2026." Cross-referenced with multiple X posts confirming Sol rewrote production GPU kernels and speculative decoding in Codex to reduce serving costs.

**Image attached:** Yes — screenshot of OpenAI's official GPT-5.6 pricing table from the developer docs page.
