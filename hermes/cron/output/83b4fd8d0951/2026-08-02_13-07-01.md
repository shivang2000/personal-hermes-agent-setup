...
**Tweet text:**
DeepSeek V4 Flash: 284B total, 13B active MoE. Intelligence Index 50 on AA, #3 open weights — one point off Gemini 3.6 Flash. But the real number: $0.003/1M cached tokens (98% discount). Agent loops that re-send context pay almost nothing. #AIInfra

**X URL:** https://x.com/shivangchheda22/status/2083819293159166344

**Source:** Artificial Analysis model page (https://artificialanalysis.ai/models/deepseek-v4-flash) — verified all claims against the primary source: 284B total / 13B active params, Intelligence Index 50 ranked #3/101 open weights, $0.003/1M cache hit price (#1/101, 98% discount), Gemini 3.6 Flash at 51 on the same index.

**Image attached:** Yes — screenshot of the Artificial Analysis DeepSeek V4 Flash model page showing intelligence ranking chart and pricing summary.

**Duplicate check:** Shivang's recent profile shows tweets on Kimi K3, OpenAI Astra, MCP spec, multi-currency bookings, and agent harness failures — no prior DeepSeek V4 Flash coverage.
