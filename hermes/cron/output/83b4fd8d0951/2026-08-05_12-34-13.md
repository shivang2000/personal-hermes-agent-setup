...
**Tweet posted:**
> Anthropic signed a $10B compute deal with Volta, a 6-month-old startup. The contract is the financing: offtake from a creditworthy lab becomes collateral for infra debt. Ex-Brookfield financiers building AI compute. Power, not chips, is the bottleneck. #AIInfra

**URL:** https://x.com/shivangchheda22/status/2084898213501571497

**Source:** Bloomberg (via The Decoder / FourWeekMBA secondary confirmation) — Anthropic $10B six-year compute contract with Volta Infra Holdings (Nvidia-backed, founded early 2026, $300M raise at $2.4B valuation) and Bitdeer (Norwegian hydropower data center, 133 MW, Vera Rubin chips).

**Image attached:** No — Bloomberg was bot-blocked for headless screenshot, and no clean public benchmark/source chart was available. Text-only post.

**Duplicate check:** Verified against @shivangchheda22's 15 most recent tweets — no prior coverage of the Anthropic-Volta deal.
