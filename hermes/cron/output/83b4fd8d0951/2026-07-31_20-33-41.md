...
**Breaking-news post published.**

- **Tweet:** "DeepMind Gemini Robotics 2 runs legs, torso, arms and fingers under a single VLA policy. Previous models drove arms while legs ran separate code. Getting both in one policy is the actual hard part. Plus an on-device variant that runs locally on the robot."
- **X URL:** https://x.com/shivangchheda22/status/2083206926155100270
- **Source:** https://deepmind.google/models/gemini-robotics/ (Google DeepMind official page)
- **Image attached:** Yes — screenshot of the DeepMind Gemini Robotics product page
- **Event:** Gemini Robotics 2 launch — whole-body VLA control under a single policy, including an on-device variant. 598 points / 486 comments on HN, actively discussed on X.

DeepSeek V4 Flash was also detected as breaking but Shivang already posted about it at 13:37 IST, so no duplicate was made.
