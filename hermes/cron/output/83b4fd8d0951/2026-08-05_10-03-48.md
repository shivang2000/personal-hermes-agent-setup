...
**Tweet posted:** https://x.com/shivangchheda22/status/2084860328089952736

**Text:** "Mistral open-sourced Shieldstral: 3B safety classifier, Apache 2.0. The real move is policy-adaptive, you write moderation rules as plain-language questions at inference time. No retraining for new policies. One model, text + image, single 16GB GPU."

**Source:** https://mistral.ai/news/shieldstral/ (Mistral AI official announcement, Aug 4 2026)

**Image attached:** Yes — top banner crop of the Mistral Shieldstral announcement page (1440x400 jpg).

**Why this fired:** Shieldstral is a significant open-source model release (Apache 2.0, 3B params, novel policy-adaptive moderation mechanism) confirmed against the primary source (Mistral's own announcement page) and trending on HN (342 pts). Not previously covered in Shivang's recent tweets. Fits his builder voice on guardrails/agent safety, with a concrete technical mechanism (policy-as-plain-language-question at inference time, no retraining) rather than generic commentary.
