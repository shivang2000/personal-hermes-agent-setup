...
**Breaking-news post confirmed.**

**Posted text:**
DeepSeek V4 Flash 0731 hit 50 on the Artificial Analysis Intelligence Index, tying Gemini 3.6 Flash and beating V4 Pro (44). $0.14/$0.28 per 1M tokens, cache hits at $0.003. 1M context. The cheap reasoning model is now competitive with frontier labs.

**X URL:** https://x.com/shivangchheda22/status/2083146608968126504

**Image attached:** Yes — screenshot of the Artificial Analysis model page showing the Intelligence Index score, pricing, and comparison chart.

**Sources confirmed:**
- Artificial Analysis (artificialanalysis.ai/models/deepseek-v4-flash): Intelligence Index #2/162 at 50, price #1/162 at $0.14/$0.28 per 1M tokens, cache hit $0.003/1M (-98%), 1M context window
- DeepSeek API Docs (api-docs.deepseek.com): Model version DeepSeek-V4-Flash-0731, 1M context, 384K max output, $0.14 input / $0.28 output per 1M tokens, cache hit $0.0028/1M
- HN front page: 325 points, 155 comments on the DeepSeek-V4-Flash Update post (4h ago)
- X search confirmed active breaking conversation with multiple users discussing the benchmark results in real time

**Duplicate check:** Shivang's 5 most recent tweets covered OpenAI eval agent, inference API sessions, Anthropic sandbox escapes, and Gemini Spark. No DeepSeek V4 Flash coverage. Clean post.
