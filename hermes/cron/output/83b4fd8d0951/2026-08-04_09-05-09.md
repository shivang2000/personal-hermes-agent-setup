...
The tweet posted successfully and is now visible on the profile. The initial verification check just ran before X finished processing.

**Posted tweet:**

**Text:** OpenAI Astra solved 10 open math problems. Every proof formalized in Lean, published at github.com/openai/ten-proofs. ~$2k compute. The architecture is multi-instance long-horizon: several instances running for hours on one problem, revising as dead ends surface.

**URL:** https://x.com/shivangchheda22/status/2084483076802121959

**Source:** OpenAI research report "Ten advances in mathematics and theoretical computer science" (openai.com/index/ten-advances-in-mathematics), cross-referenced via evermx.com case page and X search. Key claims confirmed: 10 open problems solved across 6 fields, Lean-formalized proofs published at github.com/openai/ten-proofs, ~$2,000 internal compute cost, multi-instance long-horizon architecture.

**Image attached:** Yes — screenshot of github.com/openai/ten-proofs (the Lean proof repository), 1440×1000, converted to optimized JPEG.

**Character count:** 263 (within 280 limit, close to 260 preference).
