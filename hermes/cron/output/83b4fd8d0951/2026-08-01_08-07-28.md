...
**Breaking-news post — GPT-5.6 API price cuts**

**Tweet text:**
> OpenAI cut GPT-5.6 Luna 80% to $0.20/$1.20 per M tokens. Terra down 20%. Sol unchanged. Mechanism: Sol optimized its own inference kernels to cut serving costs 20%, then subsidized cheaper tiers. Flagship margin funds the price war. #AIAgents

**X URL:** https://x.com/shivangchheda22/status/2083381517687099466

**Source:** OpenAI official pricing page at developers.openai.com/api/docs/pricing — confirmed Luna $0.20/$1.20, Terra $2.00/$12.00, Sol $5.00/$30.00 per 1M tokens (standard tier). The self-optimization mechanism (Sol rewriting its own inference kernels to reduce serving costs ~20%) was corroborated across multiple independent X posts citing OpenAI's announcement.

**Image attached:** Yes — screenshot of OpenAI's official pricing table showing the current GPT-5.6 family prices.

**Duplicate check:** Shivang's last 15 tweets reviewed — no prior post on this pricing change.
