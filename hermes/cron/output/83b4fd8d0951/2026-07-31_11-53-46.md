...
**Breaking-news post fired successfully.**

**Tweet text:**
OpenAI cut GPT-5.6 Luna 80% to $0.20/1M input, making it #1 on Artificial Analysis at near-commodity pricing. Auto-review in Codex CLI now costs ~10x less. Agent review loops that ran $50/day are $5. That changes who can afford autonomous review cycles. #AIAgents

**X URL:** https://x.com/shivangchheda22/status/2083076076763508984

**Source:** OpenAI's official X account announcement (Jul 30, 17:17 UTC) confirming GPT-5.6 Luna price cut (80% → $0.20/1M input), Terra down 20%, Sol Fast mode (2.5x speed at 2x price), and Auto-review upgrade to Luna (~10x cost reduction). Cross-referenced with Artificial Analysis model page showing Luna at #1 Intelligence Index with $0.20/$1.20 pricing.

**Image attached:** Yes — screenshot of Artificial Analysis GPT-5.6 Luna model page showing pricing and Intelligence Index ranking.

**No duplicate check:** Shivang's recent tweets covered Gemini Robotics 2 and the Anthropic Claude sandbox breakout — no prior post on the OpenAI price cuts.
