...
- **Tweet text:** Kimi K3 (2.8T params) does not fit on a B200 node. AMD MI355X has the same 288GB as B300 at 2.4x lower cost: 48 tok/s/$ vs 33. But the benchmark assumes $2.50/GPU-hr. Cheapest real on-demand listing is $8.60+. Price the listing, not the benchmark.
- **X URL:** https://x.com/shivangchheda22/status/2083856032258998370
- **Source:** Wafer blog post (https://wafer.ai/blog/kimi-k3-mi355x) + HN discussion (https://news.ycombinator.com/item?id=49141073) confirming real-world pricing gap
- **Image attached:** Yes — benchmark comparison table (MI355X vs B200 vs B300) from the Wafer blog
- **Length:** 247 characters
- **Angle:** The benchmark-vs-real-pricing gap. Wafer's perf/dollar win assumes $2.50/GPU-hr for MI355X, but the only actual on-demand listing (Oracle) is $8.60+, which collapses the edge. A "price the listing, not the benchmark" builder takeaway — concrete, tradeoff-focused, no hype.
