...
- **Text:** "OpenAI's Astra solved 10 open math problems. Every proof ships with a Lean 4 machine-checkable certificate on GitHub. You can clone the repo and run the verifier yourself instead of taking the model's word for it."
- **URL:** https://x.com/shivangchheda22/status/2084324568194568467
- **Source:** GitHub repo (openai/ten-proofs, Apache-2.0, 412 stars) — Lean 4 formalizations for 10 long-open math/TCS problems, including sphere packing, metric codes, non-sofic groups, Connes rigidity, and more. HN thread with 334 comments and 462 points. Also confirmed via X search: @Aaron_Harme noted OpenAI's previous Erdős claim was called "dramatic misrepresentation" by the Erdős problem database maintainer — this time the Lean 4 certificates close that verification gap.
- **Image attached:** Yes — screenshot of the GitHub repo showing the 10 Lean proof files and README.
