...
The two major breaking AI events today — ByteDance Seedance 2.5 and Kimi K3 — were both already posted by Shivang in the last 55 minutes. DeepSeek V4 Flash was posted 11 hours ago. The HN front page and X searches show no new model release, benchmark, API/pricing change, safety finding, or open-source launch beyond what's already covered. The broad X search returned the usual spam/noise (known pitfall).
