...
- **Tweet text:** DeepSeek V4 Flash 0731 jumped 10 pts on AA Intelligence Index. Mechanism: hallucination rate dropped 12 pts, accuracy flat at 37%. Same 284B/13B active. Got smarter by talking less, not knowing more. 12% fewer output tokens. #AIInfra
- **X URL:** https://x.com/shivangchheda22/status/2083864181414228416
- **Image attached:** Yes — screenshot of Artificial Analysis article on V4 Flash 0731 benchmark results
- **Source:** Artificial Analysis, "DeepSeek V4 Flash 0731 scores 50 on the Artificial Analysis Intelligence Index, 10 points above previous DeepSeek V4 Flash" (July 31, 2026)
