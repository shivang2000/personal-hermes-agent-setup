...
```
TimeoutError: Cron job 'AI/Tech breaking-news trigger (30m)' idle for 696s (limit 600s) — last activity: terminal command running (10s elapsed)
```
