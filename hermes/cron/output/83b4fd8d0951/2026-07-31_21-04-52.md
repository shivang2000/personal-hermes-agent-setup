...
Posted successfully. Here is the final report:

**Posted tweet:** https://x.com/shivangchheda22/status/2083214761769275797

**Text:**
> DeepSeek-V4-Flash just hit public beta. Same architecture, re-post-trained only. TerminalBench 2.1: 82.7, DeepSWE: 54.4. $0.14/M input, 3x cheaper than V4-Pro. Native Responses API + Codex support. The cheap agent tier is getting crowded fast.

**Source:** DeepSeek official API updates page (api-docs.deepseek.com/updates/), dated 2026-07-31. Confirmed: V4-Flash-0731 is re-post-trained only (same arch/size as preview), public beta, agent benchmarks (TerminalBench 2.1: 82.7, DeepSWE: 54.4, Toolathlon 70.3), pricing $0.14/M input cache miss / $0.28/M output, native Responses API + Codex adaptation.

**Image attached:** Yes — cropped screenshot of the DeepSeek API updates page showing the V4-Flash update section and benchmark list.

**Duplicate check:** Shivang's last 15 posts do not cover DeepSeek-V4-Flash. No collision.
