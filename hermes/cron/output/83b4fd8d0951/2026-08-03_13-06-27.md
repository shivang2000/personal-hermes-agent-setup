...
**BREAKING NEWS POST — AI Price War**

**Posted text:**
> OpenAI cut GPT-5.6 Luna 80% to $1.20/M output. DeepSeek V4 Flash hit 82.7 on Terminal-Bench at $0.28/M. Cheaper inference changes which agent workflows survive at scale. A 10k-task/day agent just went from unsustainable to break-even.

**X URL:** https://x.com/shivangchheda22/status/2084181533943034324

**Image attached:** Yes — screenshot of OpenAI's official pricing page (developers.openai.com/api/docs/pricing) showing the GPT-5.6 Luna and Terra pricing table.

**Sources confirmed:**
- OpenAI official pricing page (primary): gpt-5.6-luna at $0.20/$1.20 per 1M tokens, gpt-5.6-terra at $2.00/$12.00 per 1M tokens
- Multiple X accounts reporting 80% Luna cut and 20% Terra cut within the last hour
- DeepSeek V4 Flash: $0.14/$0.28 per 1M input/output tokens, 82.7 on Terminal-Bench 2.1 (confirmed via Reuters and Artificial Analysis citations on X)
- Shivang's recent tweets checked — no duplicate angle (his recent posts covered agent sandbox escapes and Karpathy's Opus 5 demo, not pricing)

**Why this qualified as breaking:** Major API pricing change from OpenAI + significant open-source model release from DeepSeek, both within the last hour, with direct implications for production agent economics.
