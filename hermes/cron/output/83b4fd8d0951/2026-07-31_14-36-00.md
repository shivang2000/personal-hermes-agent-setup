...
> DeepMind shipped Gemini Robotics ER 2: a brain for robots that plans multi-step tasks, tracks progress via live video, and delegates motor execution to VLA models. Thinks while acting through the Gemini Live API. 91.3% moment-finding at 0.96s latency. #AIAgents

**URL:** https://x.com/shivangchheda22/status/2083116913660662227

**Source:** Google DeepMind official blog — "Introducing Gemini Robotics ER 2" (Jul 30, 2026) at https://blog.google/innovation-and-ai/models-and-research/google-deepmind/gemini-robotics-er-2/

**Image attached:** Yes — screenshot of the Google DeepMind blog article (chart comparing ER 1.6 vs ER 2 physical agent performance, progress classification, and moment-finding benchmarks).

**Why this qualified as breaking:** Google DeepMind released Gemini Robotics ER 2, a major new embodied reasoning model for robotics — publicly available on the Gemini API and AI Studio. This is a significant model release from a major AI lab, meeting the breaking-news criteria. Shivang had not yet posted about it (checked profile — only DeepSeek-V4-Flash, GPT-5.6 pricing, and Anthropic cyber eval posts from earlier today).
