...
**Text:** Kimi K3 is 2.8T params — 1.5TB VRAM before KV cache. Won't fit on a single B200 node. AMD MI355X has 288GB/GPU too, at 2.4x lower cost than B300. Result: 48 tok/s/$ vs 33 on B300, 7 on B200. The CUDA moat for frontier inference is looking thin. #AIInfra

**URL:** https://x.com/shivangchheda22/status/2083795945809158487

**Source:** wafer.ai/blog/kimi-k3-mi355x (front page HN, July 31 2026 post by Ian Ye)

**Image attached:** Yes — cropped screenshot of the article headline + benchmark comparison table (MI355X vs B200 vs B300 throughput and perf/dollar).

**Why this fired:** Kimi K3 (2.8T params) is a major open-source model release, and the wafer.ai benchmark showing AMD MI355X beating NVIDIA B300 on performance-per-dollar for frontier inference is a significant infra finding with concrete numbers (48 vs 33 vs 7 tok/s/$). No duplicate in Shivang's recent tweets. Credible primary source with full methodology.
