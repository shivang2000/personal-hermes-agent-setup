...
**Text:** Kimi K3 is open weight, but the license has a Model-as-a-Service clause. Companies doing >$20M/yr need a separate commercial agreement with Moonshot AI before hosting it. That's why Ollama charges extra on Pro Max. Open weights, not open power for production. #AIInfra

**URL:** https://x.com/shivangchheda22/status/2083895462625747042

**Image attached:** Yes — HuggingFace Kimi-K3 model card screenshot (1440×1000, 2.8T params, Moonshot AI)

**Source:** HuggingFace LICENSE file at huggingface.co/moonshotai/Kimi-K3/blob/main/LICENSE (primary, verified directly). Confirmed the "Model as a Service" clause: affiliates exceeding $20M revenue over 12 consecutive months must enter a separate commercial agreement with Moonshot AI before using Kimi K3 commercially. This is why Ollama charges extra even on Pro Max subscriptions.

**Character count:** 268 (under 280, within the 260 edit buffer after humanizer).

**Humanizer pass:** No AI-isms, no em-dashes, no rule-of-three, no hedging. Direct builder voice with concrete mechanism (the license clause + Ollama pricing consequence).
