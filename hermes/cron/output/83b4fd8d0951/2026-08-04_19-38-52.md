...
**Tweet:** OpenAI Astra solved 10 open math problems with Lean-checked proofs for ~$2k compute. The cert repo had 1 star. Nobody ran the 2-command verification. Free to check and nobody did. That's the adoption gap, not a capability gap.

**URL:** https://x.com/shivangchheda22/status/2084642673395384487
**Image:** None (text-only)
**Source:** OpenAI blog post "Ten advances in mathematics and theoretical computer science" (HN #14, 577 points) + X discussion from @Vladic_ETH noting the repo had 1 star and zero forks, and @geeknik noting ~$2,000 token cost.
