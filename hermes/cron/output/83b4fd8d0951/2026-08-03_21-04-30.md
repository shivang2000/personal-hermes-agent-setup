...
**Posted tweet:**
> Qwen3.8-Max: 2.4T params, 95B active MoE. $2/$6 per M tokens. TerminalBench 86.6 beats Fable 5 (84.6), trails GPT 5.6 (88.8). First open-weight Max-class Qwen, weights land next week. Sparse routing=REDACTED_SET_LOCALLY

**X URL:** https://x.com/shivangchheda22/status/2084301850350936074
**Image attached:** No (Qwen.ai landing page screenshot was just the generic dark homepage, not a clean proof artifact — posted text-only rather than filler)
**Source:** Qwen.ai official announcement page (2026/08/03), confirmed via X search results citing 2.4T params / 95B active MoE, TerminalBench 86.6, $2/$6 pricing, open weights next week. 867 points on HN with 444 comments.
**Duplicate check:** Shivang's 5 most recent tweets reviewed — no prior Qwen3.8-Max coverage.
