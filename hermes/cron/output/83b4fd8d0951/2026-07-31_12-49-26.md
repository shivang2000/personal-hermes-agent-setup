...
```
TimeoutError: Cron job 'AI/Tech breaking-news trigger (30m)' idle for 603s (limit 600s) — last activity: waiting for non-streaming API response
```
