...
**Tweet text:**
> Gemini Robotics 2 controls full humanoids now, not just arms. On-device VLA adapts to a new robot body in a few hours with <200 examples. But floor pickup accuracy is 45.7%. Whole-body control is arriving; reliability is not.

**X URL:** https://x.com/shivangchheda22/status/2083064234657890681

**Source:** Google DeepMind blog post, July 30 2026 — "Gemini Robotics 2 brings whole body intelligence to robots"

**Image attached:** Yes — screenshot of the DeepMind blog post (benchmark chart with floor pickup accuracy visible)

**Why this qualified as breaking:** Major model release from DeepMind. First whole-body humanoid control (feet to fingertips) in their robotics line, on-device VLA that adapts to new embodiments in hours, and notably honest benchmark numbers (45.7% floor pickup). The post leads with the concrete mechanism (VLA + on-device adaptation), includes the real tradeoff (low floor-pickup accuracy), and avoids hype framing.
