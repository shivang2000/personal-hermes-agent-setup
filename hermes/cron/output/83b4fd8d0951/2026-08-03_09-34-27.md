...
Posted a breaking-news tweet on the MiniMax H3 open-weight video model release.

**Final text:**
> MiniMax H3 open weights dropped. Omni-modal video: text, image, video, audio in, 2K video with native stereo out. Runs locally on RTX 5090 via SGLang. But the community license excludes US, UK, EU, and South Korea. Open weights, closed markets.

**X URL:** https://x.com/shivangchheda22/status/2084128184740782454

**Source:** Hugging Face model card (https://huggingface.co/MiniMaxAI/MiniMax-H3) and LICENSE file, confirming the omni-modal I/O specs, RTX 5090/SGLang local inference, and the community license's Excluded Territories clause (US, UK, EU, South Korea). Cross-referenced with X search results from @Hailuo_AI, @GGUFzy, and @zeroclaw_build.

**Image attached:** Yes — screenshot of the Hugging Face model card page showing the MiniMax H3 overview and specs.

**Why this qualified as breaking:** Significant open-source model release — first open-weight omni-modal video generator with native stereo audio at 2K, from a major Chinese AI lab. The license geographic exclusion is a concrete, verifiable tradeoff that matters to builders considering adoption. No duplicate of Shivang's recent posts (his last 5 tweets covered Qwen3.8-Max, OpenAI Astra math proofs, DeepSeek V4 Flash, and a production-vs-demo observation — none touched MiniMax H3).
