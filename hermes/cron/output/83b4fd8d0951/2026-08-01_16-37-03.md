...
DeepSeek V4 Flash 0731: 82.7 on Terminal-Bench 2.1, up from 56.9 in April. 284B MoE, 13B active, MIT weights. Beats its own V4 Pro (5x larger) on all 9 agent benchmarks. 1pt behind Luna at $0.03/task. Open-closed gap is now a routing call, not a capability cliff. #AIAgents

**X URL:** https://x.com/shivangchheda22/status/2083509759186251845

**Image attached:** Yes — screenshot of Artificial Analysis's confirmation tweet (@ArtificialAnlys, 688 likes) announcing DeepSeek V4 Flash 0731 open weights release.

**Source:** Artificial Analysis (@ArtificialAnlys) tweet + multiple X posts confirming Terminal-Bench 2.1 score (82.7, up from 56.9), 284B MoE / 13B active architecture, MIT license, $0.03/task cost. No overlap with Shivang's recent tweets (his Luna price-cut tweet covered pricing, not the agent benchmark jump or open-weights infra angle).
