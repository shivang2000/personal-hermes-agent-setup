...
Shivang's profile shows a Qwen3.8-Max tweet was already posted **18 seconds ago** — it covers the exact same event with the same cost-comparison angle I was about to use:

> "Qwen3.8-Max: 2.4T MoE, open weights, beats GPT-5.6 and Fable 5 on coding. $2/$6 per 1M, cache hit $0.25. DeepSeek V4 Flash is 14x cheaper on input. Open-source frontier is splitting into two lanes: cheapest inference vs strongest coding. #OpenSource #LLM"

The event is already covered. No duplicate needed.
