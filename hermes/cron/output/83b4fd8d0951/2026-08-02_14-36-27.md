...
**Breaking-news post: OpenAI Astra — ten new math proofs with Lean 4 certificates**

- **Tweet text:** OpenAI's Astra (unreleased) produced 10 new math proofs, each open 10+ years. Every proof is a Lean 4 file you can check on a laptop. ~$2,000 in tokens total. The model isn't public, but the verifiability pattern is: machine-checked proofs > vibe checks.
- **X URL:** https://x.com/shivangchheda22/status/2083841792412352689
- **Image attached:** Yes — screenshot of github.com/openai/ten-proofs showing the repo with all 10 Lean 4 proof files and the repo title.
- **Primary source:** https://github.com/openai/ten-proofs (265 stars, 24 forks, Apache-2.0, Lean 4 formalizations for SpherePacking, MetricCodes, NonSoficGroup, ConnesRigidity, Permanent, QuantumParallelRepetition, GapCVP, EhrhartVolumeInequality, MulticolorTriangleRamsey, CompactnessAndDegeneracy)
- **Why this is breaking:** Astra is OpenAI's "next major model" — it produced original mathematical results before public release, with machine-checkable proofs. This is a first for AI-generated novel math at this scale.
- **Duplicate check:** Confirmed no prior tweet from @shivangchheda22 about Astra (profile scan returned recent posts about DeepSeek V4 Flash, GPT-5.6 pricing, Supabase Evals, MCP, and agent routing — none about Astra).
