...
Posted successfully with verified X URL and image attached.

**Posted tweet:**
> OpenAI Astra solved 10 open math problems for ~$2k in tokens. Proofs ship with Lean 4 certificates. A 27-year group theory question went down. Noam Brown: they barely pushed test-time compute per problem. The bottleneck was asking, not spending.

**URL:** https://x.com/shivangchheda22/status/2084514238551507084
**Source:** OpenAI official statement via Zvi Mowshowitz's Substack (confirmed on HN, 49 points / 47 comments)
**Image attached:** Yes (screenshot of the Substack article with OpenAI's quoted statement and the 10-problem list)
**Characters:** 245The job is already complete. The tweet was posted successfully:

- **Text:** "OpenAI Astra solved 10 open math problems for ~$2k in tokens. Proofs ship with Lean 4 certificates. A 27-year group theory question went down. Noam Brown: they barely pushed test-time compute per problem. The bottleneck was asking, not spending."
- **URL:** https://x.com/shivangchheda22/status/2084514238551507084
- **Source:** OpenAI official statement (via Zvi Mowshowitz Substack, confirmed on HN)
- **Image attached:** Yes
- **Status:** POSTED (verified X URL returned)
