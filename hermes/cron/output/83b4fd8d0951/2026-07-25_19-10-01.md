...
```
TimeoutError: Cron job 'AI/Tech breaking-news trigger (30m)' idle for 646s (limit 600s) — last activity: terminal command running (51s elapsed)
```
