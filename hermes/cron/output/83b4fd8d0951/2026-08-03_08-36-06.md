...
- **Tweet text:** "OpenAI's next model Astra solved 10 open math problems stuck 10-27 years. Under $2K compute each. Proofs are Lean 4 formalizations on GitHub, independently verifiable. Not just claims. Machine-checked math."
- **X URL:** https://x.com/shivangchheda22/status/2084113458195493195
- **Image attached:** Yes — screenshot of the openai/ten-proofs GitHub repo showing the 10 Lean proof files
- **Source:** OpenAI's ten-proofs repo (github.com/openai/ten-proofs) confirmed via Simon Willison's blog writeup. Key facts: internal Astra model version solved 10 open math/CS problems stuck 10-27 years, under $2K compute each, with Lean 4 formalizations published for independent verification.
