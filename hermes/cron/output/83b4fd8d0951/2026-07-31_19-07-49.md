...
**Breaking-news trigger fired: DeepSeek V4 Flash 0731 open-weight release**

**Posted tweet:**
> DeepSeek V4 Flash 0731: open weights, MIT. TerminalBench 2.1 jumped 61.8 to 82.7, within 3 pts of Opus 4.8. DeepSWE 7.3 to 54.4. Same 13B active MoE, better post-training. $0.14/$0.28 per MTok. Open weights are eating the pricing moat. #OpenSource

**URL:** https://x.com/shivangchheda22/status/2083185310440300674

**Image attached:** Yes — screenshot of the HuggingFace model card (benchmark table)

**Source:** HuggingFace model card at https://huggingface.co/deepseek-ai/DeepSeek-V4-Flash-0731 — confirmed open weights, MIT license, 304B params, benchmark table with TerminalBench 2.1 (82.7), DeepSWE (54.4), and other agentic benchmarks. Pricing ($0.14/$0.28 per MTok) cross-referenced from multiple X posts and the Artificial Analysis Intelligence Index (score: 50, +10 over April preview).

**Why this qualified as breaking:** Major open-weight model release from DeepSeek. Open weights at MIT license, beats V4-Pro on agent benchmarks, within 3 points of Opus 4.8 on TerminalBench at a fraction of the cost. Same MoE architecture with substantially better post-training.

**Duplicate check:** Shivang's recent tweets covered Kimi K3 and OpenAI Luna price cut, but not DeepSeek V4 Flash 0731 specifically. No duplicate.
