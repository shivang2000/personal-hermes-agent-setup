...
- **Text:** Kimi K3 on AMD MI355X beats B300 on perf/dollar. 952 tok/s/node vs B300's 1568 — but MI355X is 2.4x cheaper per GPU. The real blockers were software bugs: a missing top_k_renorm_prob function and a head-count shape mismatch (12→16 zero-pad). Not a hardware limit. #AIInfra
- **URL:** https://x.com/shivangchheda22/status/2083879133826928916
- **Source:** https://wafer.ai/blog/kimi-k3-mi355x (confirmed via HN front page, 136 points)
- **Image attached:** Yes — full-page screenshot of the Wafer blog post including the benchmark comparison table (MI355X vs B200 vs B300: decode tok/s, peak aggregate, perf/$)
- **Status:** POSTED, verified X URL returnedThe task is already complete. The tweet was posted successfully with a verified X URL:

**https://x.com/shivangchheda22/status/2083879133826928916**

Status: `POSTED` with image attached. No further action needed.
