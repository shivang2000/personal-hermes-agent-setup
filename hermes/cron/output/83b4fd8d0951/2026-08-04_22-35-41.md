...
**Text posted:**
> OpenAI's Astra reveal skipped benchmarks. 10 open math problems, proofs formalized in Lean, independently checkable. Verification cost ~$2k in tokens. Trust our benchmark becomes check the proof yourself.

**X URL:** https://x.com/shivangchheda22/status/2084687189045321990

**Source:** OpenAI published details of its next model (codename "Astra") on August 1, 2026 — 10 long-standing open math problems solved with proofs formalized in Lean for independent verification. Confirmed via multiple X sources and the OpenAI announcement page (openai.com/index/astra-mathematical-discoveries/).

**Image:** Not attached. Screenshot capture of the OpenAI page hit a bot-detection wall (Cloudflare "Just a moment..." interstitial), producing a near-blank image. Posted text-only rather than attaching a non-legible screenshot.

**Duplicate check:** Shivang's recent tweets covered Qwen3.8-Max, LFM2.5, DeepSeek V4 Flash, AIDE², and Cloudflare KV cache quantization. No prior Astra coverage.
