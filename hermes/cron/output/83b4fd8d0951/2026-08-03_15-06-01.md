...
- **Text:** OpenAI's unreleased Astra model solved 10 open math problems. Every proof ships with a Lean 4 certificate on GitHub. You don't trust the claim, you run the verifier. ~$2k compute, 249-page manuscript, Apache 2.0.
- **URL:** https://x.com/shivangchheda22/status/2084211624232329388
- **Image attached:** Yes — screenshot of Noam Brown's primary announcement tweet (@polynoamial, 11.5M views)
- **Source:** Noam Brown (@polynoamial, verified OpenAI researcher), Aug 1 2026: "An internal version of Astra, @OpenAI's next major model family, solved 10 major open problems in mathematics, quantum complexity, and theoretical computer science." Cross-referenced via HN (47 points, 47 comments) and multiple X posts confirming Lean 4 certificates, ~$2k compute, 249-page manuscript, Apache 2.0 license.
- **Angle:** The verification mechanism (Lean 4 proof certificates anyone can run) is the real story — not the model name or the benchmark number. Distinct from Shivang's earlier posts today about Qwen3.8-Max, GPT pricing, and Karpathy's Pelican.
