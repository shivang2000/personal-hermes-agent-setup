...
**Tweet text:**
Mistral's Shieldstral: 3B open-weights guardrail model that treats moderation as yes/no QA. You write the policy as a plain-language question at inference time -- no retraining to retarget. Matches guard models 7x its size, runs on one 16GB GPU. Apache 2.0.

**X URL:** https://x.com/shivangchheda22/status/2084935879785886196

**Source:** https://mistral.ai/news/shieldstral (Mistral AI official announcement, Aug 4 2026)

**Image attached:** Yes — cropped screenshot of the Shieldstral announcement page showing the headline and model description.

**Why this qualified as breaking:** Significant open-weights model release (Apache 2.0) from a major AI lab, 410 points on HN, novel architecture approach (moderation-as-QA instead of fixed taxonomy), state-of-the-art multimodal moderation at 3B params. No duplicate from Shivang's recent tweets.
