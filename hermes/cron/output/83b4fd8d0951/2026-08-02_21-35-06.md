...
Post confirmed — `status: POSTED` with a verified X URL.

**Posted tweet:**
> ByteDance Seedance 2.5 just dropped: 30s single-pass video generation with multi-round extensions for minutes-long clips. Takes up to 30 images, 10 video refs, 10 audio refs. Timestamp-level edit control. API coming via BytePlus ModelArk.

**X URL:** https://x.com/shivangchheda22/status/2083947148803236317

**Source:** Primary source confirmed — ByteDance Seed Team official blog (seed.bytedance.com), dated 2026-07-31. Cross-referenced on HN (403 points, 222 comments) and X search showing active discussion. Dreamina platform banner confirms "Seedance 2.5 is now available."

**Image attached:** Yes — screenshot of the official Seedance 2.5 launch blog post, optimized to 1440×1000 JPEG.

**Duplicate check:** Reviewed @shivangchheda22's 15 most recent tweets. No prior Seedance 2.5 coverage. Recent tweets covered Kimi K3/MI355X, DeepSeek V4 Flash, Inkling-Small, and EU AI Act — all distinct topics.
