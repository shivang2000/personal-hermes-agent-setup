...
The post confirmed landed on the profile. The "not found" error was a timing race in the verification step; the post is live.

**Breaking-news post — completed**

**Text:**
> Maxwell's 1873 conjecture on electrostatic equilibria just fell. 5 point charges, 24 critical points, above the (n-1)²=16 ceiling. GPT-5.6 Sol suggested the construction. The authors verified the math by hand. arxiv.org/abs/2607.27197

**URL:** https://x.com/shivangchheda22/status/2083222040644071885

**Source:** arXiv:2607.27197 — "The Maxwell Conjecture is False" (Arathoon, Ball, Kvalheim, July 2026). Primary source confirmed: the paper's disclosure states "The idea behind this construction was suggested by an LLM (OpenAI's GPT-5.6 Sol). The authors have verified the mathematical details."

**Image attached:** Yes — screenshot of the arXiv abstract page (1440×1000, 181KB, clean public page, no cookie banners or private data).

**Why this fired:** A 150-year-old physics conjecture (Maxwell, 1873) was disproven with an LLM-suggested construction — a genuinely major AI-assisted scientific result, primary-source-backed, not yet covered by Shivang's recent posts, and within the breaking-news criteria (significant AI-related discovery). One post this run; no retry attempted.
