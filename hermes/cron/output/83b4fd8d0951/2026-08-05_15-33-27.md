...
**Breaking-news trigger report:**

- **Event:** DeepGrove released Maple-Preview, an open-source 20B-A1B ternary-weight reasoning LLM. Natively trained at ternary precision (not post-quantized), runs at 200+ tok/s on Mac mini M4 and 127 tok/s on iPhone. Solves IMO 2024 P1 (7/7). 5.3 GB checkpoint, 131K context. Open weights on Hugging Face. HN score 119 and rising.
- **Source:** https://deepgrove.ai/maple-preview (confirmed via browser snapshot) + DeepGrove's own X announcement (1,435 likes, 223 reposts)
- **Duplicate check:** Shivang's last 15 tweets reviewed — no existing Maple-Preview post. ✅
- **Tweet text:** "DeepGrove's Maple-Preview: 20B ternary-weight MoE, 1.49B active. Natively trained at ternary precision, not post-quantized — matmul becomes additions at that width. 200+ tok/s on Mac mini M4, 127 tok/s on iPhone. Solves IMO 2024 P1. 5.3 GB, 131K context. Open weights." (268 chars)
- **Image attached:** Yes — screenshot of the Maple-Preview model page showing specs and benchmark chart (1440×1000 JPEG, 109 KB)
- **X URL:** https://x.com/shivangchheda22/status/2084943254420914196
- **Status:** POSTED ✅The report is already complete. The tweet was posted successfully:

- **Tweet:** https://x.com/shivangchheda22/status/2084943254420914196
- **Text:** "DeepGrove's Maple-Preview: 20B ternary-weight MoE, 1.49B active. Natively trained at ternary precision, not post-quantized — matmul becomes additions at that width. 200+ tok/s on Mac mini M4, 127 tok/s on iPhone. Solves IMO 2024 P1. 5.3 GB, 131K context. Open weights." (268 chars)
- **Image:** Yes — benchmark/specs screenshot from deepgrove.ai/maple-preview
- **Source:** https://deepgrove.ai/maple-preview
- **Status:** POSTED ✅[Silent]
