        ...
        for line in f:
            try:
                ...
                if data.get('type') == 'assistant' and 'message' in data:
                    ...
                    main_usage['input_tokens'] +=REDACTED_SET_LOCALLY
                    main_usage['output_tokens'] +=REDACTED_SET_LOCALLY
                ...
                if data.get('type') == 'user' and 'toolUseResult' in data:
                    ...
                    if 'usage' in result and 'agentId' in result:
                        ...
                        subagent_usage[agent_id]['input_tokens'] +=REDACTED_SET_LOCALLY
                        subagent_usage[agent_id]['output_tokens'] +=REDACTED_SET_LOCALLY
...
def main():
    ...
    for usage in subagent_usage.values():
        total_usage['input_tokens'] +=REDACTED_SET_LOCALLY
        total_usage['output_tokens'] +=REDACTED_SET_LOCALLY
    ...
    total_tokens=REDACTED_SET_LOCALLY
